...
public class ShopWorkflowTests {
    ...
    private FadedTShirtProductPage fadedTShirtProductPage;
    private Cart cart;
    ...
    public void configure() {
        ...
        fadedTShirtProductPage = new FadedTShirtProductPage(webDriver);
    ...
    public void addOrangeAndBlueTShirtToShoppingCartAndContinueShopping_expectedShoppingContinuesItemsAddedToShoppingCart() {
        ...
        fadedTShirtProductPage.setQuantityField("3");
        fadedTShirtProductPage.setSizeDropdown(2);
        fadedTShirtProductPage.clickOrangeOrBlueColorButton("orange");
        fadedTShirtProductPage.clickAddFadedTShirtToCart();
        fadedTShirtProductPage.clickContinueShopping();
        fadedTShirtProductPage.setQuantityField("2");
        fadedTShirtProductPage.setSizeDropdown(3);
        fadedTShirtProductPage.clickOrangeOrBlueColorButton("blue");
        fadedTShirtProductPage.clickAddFadedTShirtToCart();
        fadedTShirtProductPage.clickContinueShopping();
        Assert.assertEquals(webDriver.getTitle(), "Faded Short Sleeve T-shirts - My Store");
        fadedTShirtProductPage.clickOnCartButton();
    ...
    public void addOrangeTShirtToShoppingCartAndRemoveIt_expectedShoppingCartEmpty() {
        ...
        tShirtsPage.clickOnFadedShortSleeveTShirt();
        fadedTShirtProductPage.setQuantityField("2");
        fadedTShirtProductPage.setSizeDropdown(1);
        fadedTShirtProductPage.clickOrangeOrBlueColorButton("orange");
        fadedTShirtProductPage.clickAddFadedTShirtToCart();
        fadedTShirtProductPage.clickProceedToCheckoutBtn();
        Assert.assertEquals(webDriver.getTitle(), "Order - My Store");
        Assert.assertEquals(cart.getSrcAttributeOrangeTShirt(), "http://automationpractice.com/img/p/1/1-small_default.jpg");
